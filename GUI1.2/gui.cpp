...
//	MenuCalculator->AddSeparator();
	...
	MenuGammaDecay->AddEntry("Weisskopf Estimation", WEISSKOPFESTIMATE);
				...
				case kCM_MENU:
					switch (parm1)
					{
						...
						case ALPHAREDUCEDWIDTH:
							...
							break;
						case WEISSKOPFESTIMATE:
								WeisskopfEstimate = new weisskopf(fClient->GetRoot(),this,(char*)"Weisskopf estimate");
							break;
						default:
							break;
					}
...
//	TGImageMap* fImage = new TGImageMap(LogoFrame, "chart.png");
//	fImage->Resize(724,488);
//	fImage->Resize(1086,732);
