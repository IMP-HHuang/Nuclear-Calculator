...
hivap::hivap(const TGWindow * p, const TGWindow * main, char *name)
{
	...
	ProjectileZNumber = new TGNumberEntry(ProjectileFrame, 0, 0, TGNumberFormat::kNESInteger);
   	ProjectileZNumber->Connect("ValueSet(Long_t)", "hivap", this, "ProjectileSetANumber()");
   	(ProjectileZNumber->GetNumberEntry())->Connect("ReturnPressed()", "hivap", this, "ProjectileSetANumber()");
	...
	ProjectileANumber = new TGNumberEntry(ProjectileFrame, 0, 0, TGNumberFormat::kNESInteger);
   	ProjectileANumber->Connect("ValueSet(Long_t)", "hivap", this, "ProjectileSetNNumber()");
   	(ProjectileANumber->GetNumberEntry())->Connect("ReturnPressed()", "hivap", this, "ProjectileSetNNumber()");
	...
	ProjectileNNumber = new TGNumberEntry(ProjectileFrame, 0, 0, TGNumberFormat::kNESInteger);
   	ProjectileNNumber->Connect("ValueSet(Long_t)", "hivap", this, "ProjectileSetANumber()");
   	(ProjectileNNumber->GetNumberEntry())->Connect("ReturnPressed()", "hivap", this, "ProjectileSetANumber()");
	...
	TargetZNumber = new TGNumberEntry(TargetFrame, 0, 0, TGNumberFormat::kNESInteger);
   	TargetZNumber->Connect("ValueSet(Long_t)", "hivap", this, "TargetSetANumber()");
   	(TargetZNumber->GetNumberEntry())->Connect("ReturnPressed()", "hivap", this, "TargetSetANumber()");
	...
	TargetANumber = new TGNumberEntry(TargetFrame, 0, 0, TGNumberFormat::kNESInteger);
   	TargetANumber->Connect("ValueSet(Long_t)", "hivap", this, "TargetSetNNumber()");
   	(TargetANumber->GetNumberEntry())->Connect("ReturnPressed()", "hivap", this, "TargetSetNNumber()");
	...
	TargetNNumber = new TGNumberEntry(TargetFrame, 0, 0, TGNumberFormat::kNESInteger);
   	TargetNNumber->Connect("ValueSet(Long_t)", "hivap", this, "TargetSetANumber()");
   	(TargetNNumber->GetNumberEntry())->Connect("ReturnPressed()", "hivap", this, "TargetSetANumber()");
...
void hivap::ProjectileSetNNumber()
{
		ProjectileNNumber->SetNumber(ProjectileANumber->GetNumber() - ProjectileZNumber->GetNumber());
}
void hivap::ProjectileSetANumber()
{
		ProjectileANumber->SetNumber(ProjectileNNumber->GetNumber() + ProjectileZNumber->GetNumber());
}
void hivap::TargetSetNNumber()
{
		TargetNNumber->SetNumber(TargetANumber->GetNumber() - TargetZNumber->GetNumber());
}
void hivap::TargetSetANumber()
{
		TargetANumber->SetNumber(TargetNNumber->GetNumber() + TargetZNumber->GetNumber());
}
