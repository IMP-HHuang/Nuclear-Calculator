...
enum Commands
{
	FILE_EXIT, MASS, BINDINGENERGY, SP, SN, QALPHA, QFUSION, Vc, SP_ISOTOPE, SP_ISOTONE, SN_ISOTOPE, SN_ISOTONE, HIVAPCALCULATE, HIVAPPARAMETER, ALPHAREDUCEDWIDTH, GAMMADECAYRATE, WEISSKOPFESTIMATE
};
